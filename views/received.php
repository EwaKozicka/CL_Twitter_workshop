...
Messages
    <div class="btn-group">
        ...
        <a href="../controller/received.php"><button class="btn">Received: <span class="badge">$nu</span> new</button></a>
        <a href="../controller/sent.php"><button class="btn">Sent </button></a>
...
if (isset($_SESSION['msgs-received'])) {
    foreach ($_SESSION['msgs-received'] as $message) {
